...
1. 从 [最新 Release](https://github.com/Kectai/emby-external-player/releases/latest) 下载 `Emby.ExternalPlayer-1.7.3.zip`，校验同页提供的 SHA-256 后取出 `Emby.ExternalPlayer.dll`。
